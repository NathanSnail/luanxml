...
local tree = nxml.parse([[<Entity name="hi"> <LuaComponent script_source_file="hamis_code.lua"> </LuaComponent> <DamageModelComponent hp="9999"> </DamageModelComponent> </Entity>]])
...
print(tree:text()) -- i have no idea how this one works, tostring uses it
print(tostring(tree))
